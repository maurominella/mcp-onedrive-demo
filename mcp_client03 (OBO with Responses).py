...
user_token = cli_cred.get_token("https://graph.microsoft.com/.default").token


# 2. Setup Foundry client
# exclude VSCode credential to avoid issues with token caching, but you can choose to include it if you use VSCode and are signed in there
